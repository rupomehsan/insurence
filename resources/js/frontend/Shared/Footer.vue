<template>
    <!-- footer-area start -->
    <div
        class="container-fluid bg-dark footer mt-5 pt-5 wow fadeIn p-d-none"
        data-wow-delay="0.1s"
    >
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="text-white mb-4">
                        <img
                            ...
                            src="/frontend/img/icon/icon-02-light.png"
                            alt=""
                        />Insure
                    </h1>
                    <p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>
                        <i class="fa fa-map-marker-alt me-3"></i>123 Street, New
                        York, USA
                    </p>
