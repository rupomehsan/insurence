    ...
    <div class="my-4 py-5 document mx-auto">
        ...
        <div class="p-2">
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                <div class="fw-bold">
                    <p>
                        Issuing Office :
                        {{ mriDetails.issuing_office ?? "Corporate Office" }}
                    </p>
                    <p>Money Receipt No.: {{ mriDetails.money_receipt_no }}</p>
                    <p>
                        Class of Insurance:
                        {{
                            mriDetails.class_of_insurance?.replace("_", " ") ??
                            "Miscellaneous"
                        }}
                    </p>
                </div>
            ...
            <div>
                ...
                <div class="d-flex">
                    ...
                    <div class="d-flex w-25">
                        ...
                        >
                            {{
                                new Date(
                                    mriDetails.mode_of_payment_date
                ...
                <div class="d-flex my-2">
                    ...
                    <p class="mx-3 border-bottom border-secondary w-75 fw-bold">
                        {{ mriDetails.issued_against ?? "EICL/CO/FC-"
                        }}{{ mriDetails.policy_no }}/{{
                            formatMonthYear(mriDetails.created_at)
                        }}
                    </p>
                </div>
        ...
        <div class="d-flex justify-content-center mt-3 gap-3">
            ...
            <Link
                ...
                :href="`motor-cycle-insurance/invoice?order_id=${mriDetails.omi_order_id}-4121&status=success`"
