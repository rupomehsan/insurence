                    ...
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            >
                                <img
                                    class="img-fluid"
                                    src="/frontend/img/icon/icon-10-light.png"
                                    alt=""
                                />
                            </div>
                        ...
                        <p class="mb-4">
                            Aliqu diam amet eos erat ipsum et lorem et sit, sed
                    ...
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            >
                                <img
                                    class="img-fluid"
                                    src="/frontend/img/icon/icon-01-light.png"
                                    alt=""
                                />
                            </div>
                    ...
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            >
                                <img
                                    class="img-fluid"
                                    src="/frontend/img/icon/icon-05-light.png"
                                    alt=""
                                />
                            </div>
                    ...
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            >
                                <img
                                    class="img-fluid"
                                    src="/frontend/img/icon/icon-08-light.png"
                                    alt=""
                                />
                            </div>
                    ...
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            >
                                <img
                                    class="img-fluid"
                                    src="/frontend/img/icon/icon-07-light.png"
                                    alt=""
                                />
                            </div>
                    ...
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            >
                                <img
                                    class="img-fluid"
                                    src="/frontend/img/icon/icon-06-light.png"
                                    alt=""
                                />
                            </div>
