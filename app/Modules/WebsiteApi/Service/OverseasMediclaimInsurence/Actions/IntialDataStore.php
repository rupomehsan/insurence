        ...
        try {
            ...
            if ($request->input('step') == 1) {
                ...
                if ($data = self::$model::query()->create($requestData)) {
                    ...
                    $defaultMrpNo = 123;
                    $maxMoneyReceiptInModel = self::$MoneyReceiptModel::max('money_receipt_no') ?? $defaultMrpNo;
                    $maxMoneyReceiptInOMIModel = self::$model::max('mrp_no') ?? $defaultMrpNo;
                    ...
                    $data->mrp_no = $money_receipt_no ?? $defaultMrpNo;
