...
class MotorcycleSslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjaxForMotorcycle(Request $request)
    {
        ...
        $post_data['cus_email'] = $payload->email ?? auth()->user()->email;
